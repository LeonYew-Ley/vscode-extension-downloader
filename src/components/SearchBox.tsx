  ...
  return (
    <div class="relative hover:shadow-lg transition-shadow">
      <input
        ...
        placeholder="搜索扩展..."
        autofocus
        class={`w-full box-border pl-12px pr-104px py-3 rounded-none border-2 border-solid outline-none transition-colors bg-white dark:bg-zinc-800 text-gray-900 dark:text-zinc-100 placeholder-gray-500 dark:placeholder-gray-400 appearance-none ${
          isFocused() 
